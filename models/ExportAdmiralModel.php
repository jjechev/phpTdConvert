...
class ExportAdmiralModel extends aExportTraitsModel
{
    ...
    private function createHotel(&$hotelData)
    {
        ...
        foreach ($boards as $board) {
            $this->createBoardAndPeriods($board, $hotelData['periods']);
     ...
     * @param array $periods
     */
    private function createBoardAndPeriods($board, $periods)
    {
        $this->worksheet->setCellValue('A' . $this->line, "Board: " . $board);
        $col = 1;
    ...
    {
        $this->worksheet->setCellValue('A' . $this->line, $hotelName);
        $this->worksheet->setCellValue('B' . $this->line, $hotelCategory . "*");
